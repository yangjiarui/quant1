...
class OrderData(object):
    ...
    def __set_date(self):
        ...
        self.date = self.cur_bar.cur_date
    ...
    def __set_price(self):
        ...
        if self.execute_mode is 'OPEN':
            self.execute_mode_price = self.cur_bar.next_open
        elif self.execute_mode is 'CLOSE':
            self.execute_mode_price = self.cur_bar.cur_close

        if self.price in ['OPEN', 'CLOSE']:
...
class Order(OrderBase):
    ...
    def __set_order_data(self):
        ...
        self.date = self._order_data.date
        self.units = self._order_data.units
